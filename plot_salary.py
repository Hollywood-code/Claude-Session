...
ymax = ax.get_ylim()[1]
ax.text(mean_salary + 1500, ymax * 0.88, f"Mean\n${mean_salary:,.0f}", color="red", fontsize=10, ha="left")
ax.text(median_salary - 1500, ymax * 0.88, f"Median\n${median_salary:,.0f}", color="blue", fontsize=10, ha="right")
